...
class MenuLevelViewModelUTest {
    ...
    void givenDifficultyLevel_whenUpdateSelectedLevel_thenSelectedLevelAndStarsAreSet() {
        viewModel.updateSelectedLevel(DifficultyLevel.EASY);
        ...
        viewModel.updateSelectedLevel(DifficultyLevel.MEDIUM);
        ...
        viewModel.updateSelectedLevel(DifficultyLevel.DIFFICULT);
